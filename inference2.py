...
parser.add_argument("--pth_dirs", default=["WideIRSTD/HoLoCoNet_280.pth.tar"], nargs='+',
...
def test():
    ...
    air_path = 'log/WideIRSTD/HoLoCoNet_280.pth.tar'
    land_path = 'log/WideIRSTD/HoLoCoNet_280.pth.tar'
    space_path = 'log/WideIRSTD/HoLoCoNet_280.pth.tar'
